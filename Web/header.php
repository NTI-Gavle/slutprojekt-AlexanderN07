...
<div id="login-container" class="hidden w-full max-w-md rounded-3xl border border-pink-800 bg-fuchsia-900 p-8 shadow-2xl">
    ...
    <p class="mt-6 text-center text-gray-300">
        ...
        <button
            ...
            class="font-semibold text-pink-400 hover:text-pink-300">
            Register here
        </button>
    </p>
</div>
<div id="register-container" class="hidden w-full max-w-md rounded-3xl border border-pink-800 bg-fuchsia-900 p-8 shadow-2xl">
